// app/api/analytics/reports-stats/volume/route.ts
...
export async function GET(req: NextRequest) {
  ...
  const backendUrl = `${process.env.NEXT_PUBLIC_ANALYTICS_URL}/api/analytics/reports-stats/volume?interval=${interval}&startDate=${startDate}&endDate=${endDate}`;
