// app/api/analytics/posts-stats/reported/route.ts
...
export async function GET(req: NextRequest) {
  ...
  const backendUrl = `${process.env.NEXT_PUBLIC_ANALYTICS_URL}/api/analytics/posts-stats/reported?interval=${interval}&startDate=${startDate}&endDate=${endDate}`;
